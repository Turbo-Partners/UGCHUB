...
import { Plus, Trash2, Copy, ShoppingBag, Store, CheckCircle } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-xl font-semibold">Integrações E-commerce</h2>
      ...
      <Card>
        ...
        <CardContent className="text-sm text-muted-foreground space-y-3">
          <p>
            <strong className="text-foreground">1. Configure o webhook:</strong> Adicione a URL do webhook na sua loja Shopify ou WooCommerce.
          </p>
          <p>
            <strong className="text-foreground">2. Vendas automáticas:</strong> Quando um cliente usa um cupom, a venda é registrada automaticamente.
          </p>
          <p>
            <strong className="text-foreground">3. Comissões calculadas:</strong> A comissão do criador é calculada com base na taxa configurada no cupom.
          </p>
          <p>
            <strong className="text-foreground">4. Acompanhe em tempo real:</strong> Veja todas as vendas e comissões na aba de vendas da campanha.
          </p>
        </CardContent>
      </Card>
    </div>
