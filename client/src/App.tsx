...
const AdminDashboardContent = lazy(() =>
  import('@/pages/admin-dashboard').then((m) => ({ default: m.AdminDashboardContent })),
);
const AdminUsersContent = lazy(() =>
  import('@/pages/admin-users').then((m) => ({ default: m.AdminUsersContent })),
);
const AdminSupportContent = lazy(() =>
  import('@/pages/admin-support').then((m) => ({ default: m.AdminSupportContent })),
);
const AdminModulesContent = lazy(() =>
  import('@/pages/admin-modules').then((m) => ({ default: m.AdminModulesContent })),
);
const AdminContentContent = lazy(() =>
  import('@/pages/admin-content').then((m) => ({ default: m.AdminContentContent })),
);
const AdminCampaignsContent = lazy(() =>
  import('@/pages/admin-campaigns').then((m) => ({ default: m.AdminCampaignsContent })),
);
const AdminFinancialContent = lazy(() =>
  import('@/pages/admin-financial').then((m) => ({ default: m.AdminFinancialContent })),
);
const AdminGamificationContent = lazy(() =>
  import('@/pages/admin-gamification').then((m) => ({ default: m.AdminGamificationContent })),
);
