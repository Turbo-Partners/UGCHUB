...
export const structuredBriefingSchema = z
  .object({
...
export const brandCanvasSchema = z
  .object({
    // Identity
...
export const campaigns = campaignSchema.table('campaigns', {
  ...
  structuredDeliverables: jsonb('structured_deliverables')
  ...
  status: text('status', { enum: ['open', 'closed'] })
    .notNull()
    .default('open'),
  visibility: text('visibility', { enum: ['public', 'private', 'community_only'] })
    .notNull()
    .default('public'),
...
export const applications = campaignSchema.table(
  'applications',
  {
    id: serial('id').primaryKey(),
...
export const favoriteCreators = miscSchema.table(
  'favorite_creators',
  {
    id: serial('id').primaryKey(),
    companyId: integer('company_id')
...
export const favoriteCompanies = miscSchema.table(
  'favorite_companies',
  {
    id: serial('id').primaryKey(),
    creatorId: integer('creator_id')
...
export const creatorReviews = miscSchema.table(
  'creator_reviews',
  {
    id: serial('id').primaryKey(),
    creatorId: integer('creator_id')
  ...
  (table) => ({
    uniqueReview: unique().on(table.companyId, table.creatorId, table.campaignId),
  }),
);

export const campaignInvites = campaignSchema.table(
  'campaign_invites',
  {
    id: serial('id').primaryKey(),
    campaignId: integer('campaign_id')
...
export const campaignTemplates = campaignSchema.table('campaign_templates', {
  ...
  visibility: text('visibility', { enum: ['public', 'private', 'community_only'] }).default(
    'public',
  ),
  minTierId: integer('min_tier_id'),
  minPoints: integer('min_points').default(0),
...
export const tags = systemSchema.table(
  'tags',
  {
    id: serial('id').primaryKey(),
    name: text('name').notNull(),
...
export const creatorTags = creatorSchema.table(
  'creator_tags',
  {
    id: serial('id').primaryKey(),
    creatorId: integer('creator_id')
...
export const brandTags = brandSchema.table(
  'brand_tags',
  {
    id: serial('id').primaryKey(),
...
export const campaignTags = campaignSchema.table(
  'campaign_tags',
  {
    id: serial('id').primaryKey(),
    campaignId: integer('campaign_id')
...
export const insertCreatorTagSchema = createInsertSchema(creatorTags).omit({
  id: true,
  createdAt: true,
});
export const insertBrandTagSchema = createInsertSchema(brandTags).omit({
  id: true,
  createdAt: true,
});
export const insertCampaignTagSchema = createInsertSchema(campaignTags).omit({
  id: true,
  createdAt: true,
});
...
export const companyMembers = companySchema.table(
  'company_members',
  {
    id: serial('id').primaryKey(),
    companyId: integer('company_id')
...
export const creatorPosts = creatorSchema.table(
  'creator_posts',
  {
    id: serial('id').primaryKey(),
    userId: integer('user_id')
...
export const creatorHashtags = creatorSchema.table(
  'creator_hashtags',
  {
    id: serial('id').primaryKey(),
    userId: integer('user_id')
...
export const postAiInsights = miscSchema.table(
  'post_ai_insights',
  {
    id: serial('id').primaryKey(),
    userId: integer('user_id')
...
export const insertFavoriteCreatorSchema = createInsertSchema(favoriteCreators).omit({
  id: true,
  createdAt: true,
});
export const insertFavoriteCompanySchema = createInsertSchema(favoriteCompanies).omit({
  id: true,
  createdAt: true,
});
export const insertCreatorReviewSchema = createInsertSchema(creatorReviews)
  .omit({ id: true, createdAt: true, updatedAt: true })
  .extend({
    rating: z.number().int().min(1).max(5),
    comment: z.string().max(1000).optional(),
  });
export const insertCampaignInviteSchema = createInsertSchema(campaignInvites).omit({
  id: true,
  createdAt: true,
  respondedAt: true,
});
export const insertDeliverableCommentSchema = createInsertSchema(deliverableComments).omit({
  id: true,
  createdAt: true,
});
...
export const insertCreatorAnalyticsHistorySchema = createInsertSchema(creatorAnalyticsHistory).omit(
...
export const insertPostAiInsightSchema = createInsertSchema(postAiInsights).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
...
export const insertCompanyUserInviteSchema = createInsertSchema(companyUserInvites).omit({
  id: true,
  createdAt: true,
  acceptedAt: true,
});
...
export const featureFlags = systemSchema.table('feature_flags', {
  ...
  module: text('module', {
    enum: ['gamification', 'advanced_analytics', 'ecommerce', 'social_listening'],
  }).notNull(),
  createdAt: timestamp('created_at').defaultNow(),
...
export const creatorBadges = gamificationSchema.table(
  'creator_badges',
  {
    id: serial('id').primaryKey(),
    creatorId: integer('creator_id')
...
export const campaignCreatorStats = campaignSchema.table(
  'campaign_creator_stats',
  {
    id: serial('id').primaryKey(),
    campaignId: integer('campaign_id')
      .notNull()
...
export const insertCampaignCreatorStatsSchema = createInsertSchema(campaignCreatorStats).omit({
  id: true,
  updatedAt: true,
});
...
export const insertCreatorPointsSchema = createInsertSchema(creatorPoints).omit({
  id: true,
  createdAt: true,
});
...
export const insertCampaignCouponSchema = createInsertSchema(campaignCoupons).omit({
  id: true,
  createdAt: true,
});
...
export const insertCreatorCommissionSchema = createInsertSchema(creatorCommissions).omit({
  id: true,
  createdAt: true,
});
...
export const walletTransactions = billingSchema.table('wallet_transactions', {
  ...
  companyWalletId: integer('company_wallet_id').references(() => companyWallets.id, {
    onDelete: 'cascade',
  }),
  creatorBalanceId: integer('creator_balance_id').references(() => creatorBalances.id, {
    onDelete: 'cascade',
  }),
...
export const pointsLedger = gamificationSchema.table(
  'points_ledger',
  {
    id: serial('id').primaryKey(),
    companyId: integer('company_id')
...
export const campaignMetricSnapshots = analyticsSchema.table(
...
export const brandCreatorTiers = brandSchema.table(
  'brand_creator_tiers',
  {
    id: serial('id').primaryKey(),
    companyId: integer('company_id')
...
export const rewardEntitlements = gamificationSchema.table(
  'reward_entitlements',
  {
    id: serial('id').primaryKey(),
    companyId: integer('company_id')
...
export const creatorDiscoveryProfiles = creatorSchema.table(
  'creator_discovery_profiles',
  {
    ...
    source: text('source', { enum: ['manual', 'apify', 'import'] })
      .notNull()
      .default('manual'),
...
export const brandCreatorMemberships = brandSchema.table(
  'brand_creator_memberships',
  {
    id: serial('id').primaryKey(),
    companyId: integer('company_id')
      .notNull()
...
export const insertCreatorDiscoveryProfileSchema = createInsertSchema(
...
export const courses = academySchema.table('courses', {
  ...
  title: text('title').notNull(),
  description: text('description'),
  level: text('level', { enum: ['basic', 'intermediate', 'advanced'] })
    .notNull()
    .default('basic'),
...
export const courseLessons = academySchema.table('course_lessons', {
  ...
  title: text('title').notNull(),
  order: integer('order').notNull().default(0),
  contentType: text('content_type', { enum: ['text', 'video', 'link', 'checklist'] })
    .notNull()
    .default('text'),
...
export const creatorCourseProgress = academySchema.table(
  'creator_course_progress',
  {
    id: serial('id').primaryKey(),
    creatorId: integer('creator_id')
      .notNull()
...
export const creatorLessonProgress = academySchema.table(
  'creator_lesson_progress',
  {
    id: serial('id').primaryKey(),
    creatorId: integer('creator_id')
      .notNull()
...
export const creatorLessonProgressRelations = relations(creatorLessonProgress, ({ one }) => ({
  ...
  lesson: one(courseLessons, {
    fields: [creatorLessonProgress.lessonId],
...
export const inspirations = contentSchema.table('inspirations', {
  id: serial('id').primaryKey(),
  scope: text('scope', { enum: ['global', 'brand'] })
    .notNull()
    .default('global'),
...
export const inspirationCollectionItems = contentSchema.table('inspiration_collection_items', {
  ...
  collectionId: integer('collection_id')
    .notNull()
    .references(() => inspirationCollections.id, { onDelete: 'cascade' }),
  inspirationId: integer('inspiration_id')
    .notNull()
...
export const inspirationCollectionsRelations = relations(
...
export const inspirationCollectionItemsRelations = relations(
  inspirationCollectionItems,
  ({ one }) => ({
    collection: one(inspirationCollections, {
      fields: [inspirationCollectionItems.collectionId],
      references: [inspirationCollections.id],
    }),
    inspiration: one(inspirations, {
      fields: [inspirationCollectionItems.inspirationId],
...
export const creatorSavedInspirationsRelations = relations(creatorSavedInspirations, ({ one }) => ({
  ...
  inspiration: one(inspirations, {
    fields: [creatorSavedInspirations.inspirationId],
    references: [inspirations.id],
  }),
}));
...
export const campaignInspirationsRelations = relations(campaignInspirations, ({ one }) => ({
  campaign: one(campaigns, {
    fields: [campaignInspirations.campaignId],
    references: [campaigns.id],
  }),
  inspiration: one(inspirations, {
    fields: [campaignInspirations.inspirationId],
    references: [inspirations.id],
  }),
}));
...
export const insertInspirationCollectionItemSchema = createInsertSchema(
  inspirationCollectionItems,
).omit({
  id: true,
  createdAt: true,
...
export const insertCreatorSavedInspirationSchema = createInsertSchema(
...
export const messageReads = messagingSchema.table(
  'message_reads',
  {
    id: serial('id').primaryKey(),
    conversationId: integer('conversation_id')
...
export const conversationsRelations = relations(conversations, ({ one, many }) => ({
  brand: one(companies, {
    ...
    references: [companies.id],
    relationName: 'brandConversations',
  }),
  ...
  company: one(companies, {
    ...
    references: [companies.id],
    relationName: 'companyConversations',
  }),
...
export const convMessagesRelations = relations(convMessages, ({ one }) => ({
  conversation: one(conversations, {
    fields: [convMessages.conversationId],
...
export const instagramProfiles = socialSchema.table(
  'instagram_profiles',
  {
    id: serial('id').primaryKey(),
    username: text('username').notNull(),
    ownerType: text('owner_type', { enum: instagramProfileOwnerTypeEnum })
      .notNull()
      .default('external'),
...
export const instagramTaggedPosts = socialSchema.table(
  'instagram_tagged_posts',
  {
    ...
    commentsAnalysis: jsonb('comments_analysis').$type<{
      positive: number;
      neutral: number;
      negative: number;
      summary: string;
...
export const instagramPostsRelations = relations(instagramPosts, ({ one }) => ({
  account: one(instagramAccounts, {
    fields: [instagramPosts.instagramAccountId],
...
export const instagramMessagesRelations = relations(instagramMessages, ({ one }) => ({
  account: one(instagramAccounts, {
    fields: [instagramMessages.instagramAccountId],
    references: [instagramAccounts.id],
  }),
}));
...
export const instagramContacts = socialSchema.table(
  'instagram_contacts',
  {
    id: serial('id').primaryKey(),
    companyId: integer('company_id')
    ...
    fullName: text('full_name'),
    profilePicUrl: text('profile_pic_url'),
    instagramProfileId: integer('instagram_profile_id').references(() => instagramProfiles.id, {
      onDelete: 'set null',
    }),
    userId: integer('user_id').references(() => users.id, { onDelete: 'set null' }),
...
export const instagramInteractions = socialSchema.table(
  'instagram_interactions',
  {
    id: serial('id').primaryKey(),
    contactId: integer('contact_id')
      .references(() => instagramContacts.id, { onDelete: 'cascade' })
      .notNull(),
    companyId: integer('company_id')
      .references(() => companies.id, { onDelete: 'cascade' })
      .notNull(),
...
export const instagramContactsRelations = relations(instagramContacts, ({ one, many }) => ({
  ...
  profile: one(instagramProfiles, {
    fields: [instagramContacts.instagramProfileId],
...
export const instagramInteractionsRelations = relations(instagramInteractions, ({ one }) => ({
  contact: one(instagramContacts, {
    fields: [instagramInteractions.contactId],
    references: [instagramContacts.id],
  }),
  company: one(companies, {
    fields: [instagramInteractions.companyId],
    references: [companies.id],
  }),
}));
...
export const metaBusinessManagers = socialSchema.table('meta_business_managers', {
  id: serial('id').primaryKey(),
  metaAdAccountId: integer('meta_ad_account_id')
...
export const metaBusinessManagersRelations = relations(metaBusinessManagers, ({ one }) => ({
  metaAdAccount: one(metaAdAccounts, {
    fields: [metaBusinessManagers.metaAdAccountId],
...
export const metaAdAccountsListRelations = relations(metaAdAccountsList, ({ one }) => ({
  metaAdAccount: one(metaAdAccounts, {
    fields: [metaAdAccountsList.metaAdAccountId],
    references: [metaAdAccounts.id],
  }),
}));
...
export const creatorAdPartnerStatusEnum = [
  'pending',
  'request_sent',
  'active',
  'expired',
...
export const creatorAdPartnersRelations = relations(creatorAdPartners, ({ one, many }) => ({
  ...
  instagramAccount: one(instagramAccounts, {
    fields: [creatorAdPartners.instagramAccountId],
    references: [instagramAccounts.id],
  }),
}));
...
export const dmTemplateTypeEnum = [
  'campaign_invite',
  'community_invite',
  'follow_up',
  'welcome',
...
export const dmSendLogs = socialSchema.table('dm_send_logs', {
  ...
  status: text('status', { enum: ['pending', 'sent', 'failed', 'delivered', 'read'] })
    .notNull()
    .default('pending'),
  errorMessage: text('error_message'),
  sentAt: timestamp('sent_at'),
...
export const dmSendLogsRelations = relations(dmSendLogs, ({ one }) => ({
  ...
  instagramAccount: one(instagramAccounts, {
    fields: [dmSendLogs.instagramAccountId],
    references: [instagramAccounts.id],
  }),
...
export const dataSourceRegistry = systemSchema.table('data_source_registry', {
  ...
  category: text('category', {
    enum: ['instagram', 'tiktok', 'meta_ads', 'youtube', 'ecommerce', 'discovery', 'utility'],
  }),
  description: text('description'),
...
export const tiktokProfiles = socialSchema.table(
  'tiktok_profiles',
  {
    id: serial('id').primaryKey(),
    ...
    syncStatus: text('sync_status', { enum: ['active', 'error', 'disconnected'] }).default(
      'active',
    ),
...
export const blogPosts = contentSchema.table(
  'blog_posts',
  {
    id: serial('id').primaryKey(),
    slug: text('slug').notNull().unique(),
...
export const campaignHashtags = campaignSchema.table(
  'campaign_hashtags',
  {
    id: serial('id').primaryKey(),
    campaignId: integer('campaign_id')
...
export const hashtagPosts = miscSchema.table(
  'hashtag_posts',
  {
    id: serial('id').primaryKey(),
    campaignHashtagId: integer('campaign_hashtag_id')
      .notNull()
      .references(() => campaignHashtags.id),
    companyId: integer('company_id')
      .notNull()
      .references(() => companies.id),
    ...
    source: text('source', { enum: ['top', 'recent'] })
      .notNull()
      .default('recent'),
